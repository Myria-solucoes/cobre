...
| [scalar_parameters.schema.json](../schemas/scalar_parameters.schema.json)               | `system/scalar_parameters.json`           | Named scalar study parameters (single-valued numeric settings)                                                         |
