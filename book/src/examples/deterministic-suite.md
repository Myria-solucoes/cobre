...
| `d17-evaporation-mixed-sign`             | Mixed-sign evaporation coefficients               | Verifies that monthly evaporation coefficients can be negative (net rainfall) or positive (evaporation loss) and that the signed `Q_ev` variable absorbs both without triggering violation slacks. |
